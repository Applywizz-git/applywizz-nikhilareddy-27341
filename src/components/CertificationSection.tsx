...
import { SiGoogle, SiCoursera } from 'react-icons/si';
import { HiAcademicCap, HiBadgeCheck, HiExternalLink, HiCloud } from 'react-icons/hi';
...
const certifications = [
  {
    ...
    description: 'Comprehensive specialization covering core machine learning concepts and models.',
  },
  {
    ...
    description: 'Focused on the lifecycle of generative AI projects using LLMs.',
  },
  {
    ...
    description: 'Advanced training in neural networks and deep learning techniques.',
  },
  {
    ...
    description: 'Specialized focus on NLP concepts and implementation.',
  },
  {
    ...
    description: 'Training in MLOps practices using modern tools like MLflow and Hugging Face.',
  },
  {
    title: 'Building Generative AI Applications with LangChain',
    issuer: 'Coursera',
    icon: SiCoursera,
    color: 'from-green-500/20 to-emerald-500/20',
    description: 'Practical training on building AI applications using the LangChain framework.',
  },
];
            ...
            >
              <div className="flip-card-inner">
                ...
                <div className={`flip-card-front glass rounded-2xl p-6 flex flex-col items-center justify-center bg-gradient-to-br ${cert.color}`}>
                  ...
                  <h3 className="font-heading font-bold text-center text-primary mb-2 text-sm md:text-base leading-tight">
                    {cert.title}
                  </h3>
