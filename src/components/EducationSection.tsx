...
const education = [
  {
    ...
    description: 'Advanced studies in Computer Science, focusing on Machine Learning and AI systems.',
    icon: HiAcademicCap,
  },
  {
    degree: 'Bachelor of Science in Computer Science',
    school: 'Sri Dattha Institute of Engineering and Science',
    location: 'Hyderabad, India',
    period: 'Jun 2018 - May 2022',
    description: 'Foundational studies in Computer Science and software engineering.',
    icon: HiBookOpen,
  },
];
